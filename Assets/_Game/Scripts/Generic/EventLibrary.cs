...
{
    public enum HostEventType { Default, Validate, Validated, SecondInstance, Information, UpdateScore, SimpleQuestion, MultipleChoiceQuestion, MultiSelectQuestion, SingleAndMultiResult, WrongApp, WRONGAPP };
